...
// Auth Components
import ProtectedRoute, { PublicRoute, AdminRoute } from '@components/auth/protected-route';
...
import { ActuatorsPage } from '@pages/actuators/actuators-page';
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="dashboard" element={<SensorsPage />} />
            ...
            <Route path="actuators">
              <Route index element={<ActuatorsPage />} />
              <Route path=":id/control" element={<ActuatorControlPage />} />
